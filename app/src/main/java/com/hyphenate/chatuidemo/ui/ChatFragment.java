...
//        }
    ...
    public void onSetMessageAttributes(EMMessage message) {
        ...
        //设置要发送扩展消息用户昵称
        message.setAttribute(Constant.USER_NAME, SharedPreferencesUtil.getInstance().getUserName());
        //设置要发送扩展消息用户头像
        message.setAttribute(Constant.HEAD_IMAGE_URL, SharedPreferencesUtil.getInstance().getUserHeadImg());
    }
