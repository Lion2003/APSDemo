...
import com.yiaosi.aps.entity.AvatarNickNameListEntity;
...
public class ConversationListFragment extends EaseConversationListFragment{
    ...
    public static AvatarNickNameListEntity listEntity;
    ...
    private void getCache() {
        ...
        listEntity = (AvatarNickNameListEntity) mCache.getAsObject(Constant.AVATAR_NICKNAME_LIST);
        if(listEntity == null) {
            listEntity = new AvatarNickNameListEntity();
        }
    }
